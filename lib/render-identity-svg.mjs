...
// A static "identity card" SVG matching the radar card's visual language
// exactly (same palette, border, HUD corner brackets, monospace type).
// Uses dot-leader rows (LABEL....... value) so it reads like a real
// terminal profile readout — same trick the original inspiration image used.
