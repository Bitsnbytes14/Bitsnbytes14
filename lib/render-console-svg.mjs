...
export function renderConsoleSVG(profile, opts = {}) {
  ...
  <text x="${width / 2}" y="${footerY + 18}" fill="${PALETTE.textMuted}" font-size="10.5" letter-spacing="1.4" text-anchor="middle">${esc(profile.footer || 'THE SUMMIT IS JUST ONE COMMIT AWAY')}</text>`;
