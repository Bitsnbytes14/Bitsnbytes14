...
// A "loadout" status bar — the game-HUD element from the inspiration image,
// but every number is a real derived metric: XP = total contributions,
// LEVEL = tier derived from XP + your role title, COMBO = current streak,
// SHIELD = longest streak ever. A full-width consistency meter sits below.
